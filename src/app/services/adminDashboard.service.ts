...
export class AdminDashboardService{
    ...
    editUserRole(user, role, operation){
        if(operation === 'add'){
            ...
            return this.http.post('http://localhost/ATNSCCR_PHP/backend/api2/insertData.php', obj, httpOptions);
        } else {
            const obj = {deleteSelection: 'userRole', userID: user, roleID: role};
            return this.http.post('http://localhost/ATNSCCR_PHP/backend/api2/removeData.php', obj, httpOptions);
        }
    }
