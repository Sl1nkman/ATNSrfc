...
function ArgumentParser(options) {
  ...
  this.User('type', 'auto', FUNCTION_IDENTITY);
  this.User('type', null, FUNCTION_IDENTITY);
  this.User('type', 'int', function (x) {
  ...
  this.User('type', 'float', function (x) {
  ...
  this.User('type', 'string', function (x) {
    return '' + x;
  });
