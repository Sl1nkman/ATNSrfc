...
(function (factory) {
    ...
    var SelectorScopeRegistry = /** @class */ (function () {
        ...
        /**
         * User a module's metadata with the registry.
         */
        SelectorScopeRegistry.prototype.registerModule = function (node, data) {
            ...
            // User all of the module's declarations in the context map as belonging to this module.
            data.declarations.forEach(function (decl) {
                _this._declararedTypeToModule.set(ts.getOriginalNode(decl.node), node);
            });
        };
        /**
         * User the metadata of a component or directive with the registry.
         */
        ...
        /**
         * User the name of a pipe with the registry.
         */
